...
contract MockERC20 is Context, IMockERC20 {
    ...
    function mint_to_example_amo(uint256 amount, address _amo_address) external override {
        ...
        _mint(_amo_address, amount);
    }

    function mint_to_mock_swap(uint256 amount) external override {
        require(msg.sender == mock_swap_address);
        _mint(mock_swap_address, amount);
    }
